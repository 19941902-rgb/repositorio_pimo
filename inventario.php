...
// 4. Ejecutar la consulta con MySQLi Orientado a Objetos$resultado = $conn->query($sql);
?>
...
<div class="container">
<div class="header"><h2>Catálogo de Inventario</h2>
<div>
...
<td> <?php echo $fila['nombre_producto']; ?> </td><td> <?php echo $fila['nombre_categoria']; ?> </td>
